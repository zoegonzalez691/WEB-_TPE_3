...
# Productos:
Por medio del endpoint _api/productos_, se obtendra la coleccion de la tabla productos con todas sus columnas, en caso de efectuarse la vista retornara el codigo 200 y se vera un JSON de esta manera:
...
## DELETE:
# Categorias:
Para eliminar la categoria, se accede mediante el id: _api/categoria/id_. El mayor problema que puede haber relacionado a eliminar una categoria, se debe a que no se va a poder eliminar si tiene productos asociados.
